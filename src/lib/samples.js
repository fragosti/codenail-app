...
def dijsktra(graph, initial):
  ...
  '3': {
    value: `                                                                                                                                                                    \n                                                                        cons                                                                                        \n                                                                     log('Try I                                                                                     \n                                                                   It')console.lo                                                                                   \n                                                                 le.log('Try It')co                                                                                 \n                                                               ry It')console.log('Tr                                                                               \n                                                             nsole.log('Try It')console                                                                             \n                                                           ('Try It')console.log('Try It'                                                                           \n                                                         )console.log('Try It')console.log(                                                                         \n                                                       log('Try It')cons     og('Try It')cons                                                                       \n                                                     It')console.log('         onsole.log('Try                                                                      \n                                                   le.log('Try It')c             ry It')console.l                                                                   \n                                                 ry It')console.lo                 e.log('Try It')c                                                                 \n                                               nsole.log('Try It                     ')console.log('T                                                               \n                                             ('Try It')console                         ('Try It')conso                                                              \n                                           )console.log('Try                            nsole.log('Try                                                              \n                                         log('Try It')cons                            ('Try It')consol                                                              \n                                       It')console.log('                            )console.log('Tr                                                                \n                                     le.log('Try It')c                            log('Try It')con                                                                  \n                                   ry It')console.lo                            It')console.log(                                                                    \n                                 nsole.log('Try It                            le.log('Try It')                                                                      \n                               ('Try It')console                            ry It')console.l                                                                        \n                             )console.log('Try                            nsole.log('Try I                                                                          \n                           log('Try It')cons                            ('Try It')consol                                                                            \n                         It')console.log('                            )console.log('Tr                                                                              \n                       le.log('Try It')c                            log('Try It')con                                                                                \n                     ry It')console.lo                            It')console.log(                                                                                  \n                   nsole.log('Try It                            le.log('Try It')                                                                                    \n                 ('Try It')console                            ry It')console.l                                                                                      \n               )console.log('Try                            nsole.log('Try I                                                                                        \n             log('Try It')cons                            ('Try It')consol                                                                                          \n           It')console.log('                            )console.log('Tr                                                                                            \n         le.log('Try It')c                            log('Try It')con                                                                                              \n        y It')console.lo                            It')console.log(                                                                                                \n        le.log('Try It                            le.log('Try It')                                                                                                  \n         It')console                            ry It')console.l                                                                                                    \n        e.log('Try                            nsole.log('Try I                                                                                                      \n        It')console                         ('Try It')consol                                                                                                        \n        .log('Try I                       )console.log('Tr                                                                                                          \n        t')console.                     log('Try It')con                                                                                                            \n        log('Try It                   It')console.log(                                                                                                              \n        ')console.l                 le.log('Try It')                                                                                                                \n        og('Try It'               ry It')console.l                                                                                                                  \n        )console.log('Try It')console.log('Try I                                                                                                                    \n        g('Try It')console.log('Try It')consol                                                                                                                      \n        console.log('Try It')console.log('Tr                                                                                                                        \n        ('Try It')console.log('Try It')con                                                                                                                          \n         nsole.log('Try It')console.log(                                                                                                                            \n           y It')console.log('Try It'                                                                                                                               \n                                                                                                                                                                    \n                                                                                                                                                                    \n                                                                                                                                                                    \n                                                                                                                                                                    \n                                                                                                                                                                    \n                                                                                                                                                                    \n                                                                                                                                                                    \n                                                                                                                                                                    \n         .log('Try It')console.log('Try It')console.log('Try It')console.log('Try It')console.log('Try It')console.lo                                               \n        It')console.log('Try It')console.log('Try It')console.log('Try It')console.log('Try It')console.log('Try It')co                                             \n        .log('Try It')console.log('Try It')console.log('Try It')console.log('Try It')console.log('Try It')console.log('                                             \n        t')console.log('Try It')console.log('Try It')console.log('Try It')console.log('Try It')console.log('Try It')con                                             \n         og('Try It')console.log('Try It')console.log('Try It')console.log('Try It')console.log('Try It')console.log(                                               \n                                                                                                                                                                    \n                                                                                                                                                                    \n                                                                                                                                                                    \n                                                                                                                                                                    \n                                                                                                                                                                    \n                                                                                                                                                                    \n                                                                                                                                                                    \n                                                                                                                                                                    \n                                                                                                                                                                    \n                                                                                                                                                                    \n                                                                                                                                                                    \n                                                                                                                                                                    \n                                                                                                                                                                    \n                                                                                                                                                                    \n                                                                                                                                                                    \n                                                                                                                                                                    \n                                                                                                                                                                    \n                                                                                                                                                                    \n                                                                                                                                                                    \n                                                                                                                                                                    \n                                                                                                                                                                    \n                                                                                                                                                                    \n                                                                                                                                                                    \n                                                                                                                                                                    `,
    size: '12x12',
